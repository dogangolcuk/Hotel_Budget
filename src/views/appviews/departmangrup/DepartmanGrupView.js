...
const DepartmanGrupView = () => {
  ...
  const tableinfo = {
    tablecaption: 'Departman Ana Kategorileri',
    apiSearch: '/departmangrup/search',
    apiOrder: '/departmangrup/order',
    apiSave: '/departmangrup',
    apiDelete: '/departmangrup',
    argSearch: {
      id: 'number',
      ad: 'text',
    },
...
export default DepartmanGrupView
